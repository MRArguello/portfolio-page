export const content = {
  ...
  experience: {
    ...
    adjust: {
      description:
        'Me incorporé a Adjust para trabajar en el Atlas Design System. Desarrollé y mantuve una librería de componentes reutilizables basada en principios de diseño compartidos, mejorando la consistencia y la experiencia de desarrollo entre productos.',
    },
    heycar: {
      description:
